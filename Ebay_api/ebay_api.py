...
d="""xxxxxxxxxxx"""#This is the url for ebay api.note that products per page and number of entries are put as queries.also you have to get appid which is in developer.also note you have to put what kind of api endpoint it is
